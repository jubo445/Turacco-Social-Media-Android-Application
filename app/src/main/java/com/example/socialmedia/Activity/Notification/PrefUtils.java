...
public class PrefUtils {
    ...
    public static void saveUser(Users user, Context context) {
        Gson gson = new Gson();
        String json = gson.toJson(user);
        saveToPrefs(context, USER_DETAIL, json);
    }

    public static Users loadUser(Context context) {
        Gson gson = new Gson();
        String ops = getFromPrefs(context, USER_DETAIL, "").toString();
        Users  obj = gson.fromJson(ops, Users.class);
